...
import com.mercohuevos.plantaincubacion.shared.mapper.IMaquinaMapper;
...
public class MaquinaImpl implements IMaquinaService {
    ...
    public MaquinaDTO crear(MaquinaRequestDTO request) {
        ...
        maquina.setEstado(tipo== TipoMaquina.NACEDORA? EstadoMaquina.DISPONIBLE : EstadoMaquina.APAGADA);
